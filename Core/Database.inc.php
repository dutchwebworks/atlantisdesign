...
class Core_Database {
	...
	// query db
	public function db_query($query, $echo_query = false)
	{
	...
	// return db array
	public function db_array($query, $echo_query = false)
	{
	...
	public function db_row($query, $echo_query = false)
	{
	...
	public function db_colum($query, $echo_query = false)
	{
		if($row_result = $this->db_array($query)) {		
	...
	// count records
	public function db_num_rows($query, $echo_query = false)
	{
		if($echo_query) echo($query);
		if($query_result = $this->db_query($query)){
